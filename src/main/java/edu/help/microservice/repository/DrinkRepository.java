...
public interface DrinkRepository extends JpaRepository<Drink, Integer> {
    ...
    @Query("SELECT new edu.help.microservice.entity.Drink(d.drinkId, d.barId, d.drinkName, d.drinkPrice, d.alcoholContent, d.drinkImage, d.drinkDiscount, d.drinkTags, d.description, d.point) " +
