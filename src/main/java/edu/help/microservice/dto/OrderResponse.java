...
public class OrderResponse {
    ...
    public OrderResponse(String message, double totalPrice, List<DrinkOrder> drinks) {
        this(message, totalPrice, drinks, ""); // Default messageType
    }
    ...
    public List<DrinkOrder> getDrinks() { return drinks; }
    public void setDrinks(List<DrinkOrder> drinks) { this.drinks = drinks; }
